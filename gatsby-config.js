...
module.exports = {
  siteMetadata: {
    ...
    landingContent: {
      ...
      motto: {
        build: "We believe in using our technical skill to build world-class solutions to contemporary problems facing society today.",
        ...
        learn: "We exist to the the knowledge and empower todays up-and-coming hackers.",
      },
      questions: [
         {
